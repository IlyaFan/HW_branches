...
//	- check if the request has certain string
...
//2. Send the request:
//	- check if the status code is 200
//	- check if the name from request is equal to name from response
//	- check if the age from request is equal to age from response
//	- check if the salary from request is equal to salary from response
//	- check if the salary*4 from request is equal to lasary though 1,5
...
//	- check if the age from request is equal to age from response
// 	- check if the salary from request is equal to salary from response
//	- check if the dog from response has name and age property
//	- check if the dog from response has the name "Luky"
//	- check if the dog from response has the age "4"
...
//4. Send the request:
//	- check if the status code is 200
//	- check if the name from the request is equal to name from the response
//	- check if the age from the request is equal to the age from the response
//	- output the first salary element from the response list into console
//	- output the second salary element from the response list into console
//	- output the third salary element from the response list into console
//	- check if the salary from the request is equal to the first element from the salary response
//	- check if the salary*2 from the request is equal to the second element from the salary response
//	- check if the salary*3 from the request is equal to the third element
//	- set the request name param as the environmental varible name
//	- set the request age param as the environmental varible age
//	- set the request salary param as the environmental varible salary
//	- output all elements from the salary's response list into console
...
//	- check if the response has [qa_salary_after_12_months] property
//	- check if the response has [qa_salary_after_1.5_year] property
//	- check if the response has [qa_salary_after_3.5_years] property]
//	- check if the response has [person] property]
//	- check if the salary from the request is equal to [start_qa_salary]
//	- check if the salary*2 from the request is equal to [qa_salary_after_6_months] from the response
//	- check if the salary*2.7 from the request is equal to [qa_salary_after_12_months] from the response
//	- check if the salary*3.3 from the request is equal to [qa_salary_after_1.5_year] from the response
//	- check if the salary*3.8 from the request is equal to [qa_salary_after_3.5_years] from the response
//	- check if the salary from the request is equal to first element from person[u_name] from the response
//	- check if the age from the request is equal to [person.u_age] from the response
//	- check if the salary*4.2 from the request is equal to [person.u_salary_5_years] from the response
//	- output all elements from the person's response list into console
